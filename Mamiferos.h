...
namespace AppZoo2 {
	...
	/// <summary>
	/// Resumen de Mamiferos
	/// </summary>
	public ref class Mamiferos : public System::Windows::Forms::Form
	{
	public:
		Mamiferos(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(188, 72);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(180, 195);
			this->label2->TabIndex = 5;
			this->label2->Text = L"Clasificación taxonómica\n\nReino: Animalia\n\nPhylum: Chordata\n\nSubphylum: Vertebrat"
				L"a\n\nClase: Mammalia\n\nFamilia: Hydrochoeridae\n\nGénero: Hydrochoerus\n\nEspecie: Hydr"
				L"ochoerus hydrochaeris";
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(148, 44);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(71, 16);
			this->label1->TabIndex = 6;
			this->label1->Text = L"Carpincho";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Forte", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(496, 44);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(62, 16);
			this->label3->TabIndex = 7;
			this->label3->Text = L"Guanaco";
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Location = System::Drawing::Point(407, 72);
			...
			this->label4->Location = System::Drawing::Point(547, 72);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(124, 195);
			...
			this->pictureBox2->Location = System::Drawing::Point(38, 326);
			...
			this->label5->Location = System::Drawing::Point(188, 326);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(141, 169);
			this->label5->TabIndex = 11;
			this->label5->Text = L"Clasificación taxonómica\n\nReino: Animalia\n\nPhylum: Chordata\n\nSubphylum: Vertebrat"
				L"a\n\nClase: Mammalia\n\nGénero: Pteropus\n\nEspecie: Pteropus vampyrus";
			// 
			// label6
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Forte", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(138, 290);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(83, 16);
			this->label6->TabIndex = 12;
			this->label6->Text = L"Murciélago";
			// 
			// pictureBox4
			// 
			...
			this->pictureBox4->Location = System::Drawing::Point(407, 326);
			...
			this->label7->Location = System::Drawing::Point(547, 326);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(123, 169);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Forte", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(496, 290);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(44, 16);
			this->label8->TabIndex = 15;
			this->label8->Text = L"Puma";
			// 
			// pictureBox3
			// 
			...
			this->pictureBox3->Location = System::Drawing::Point(38, 72);
			...
			this->Name = L"Mamiferos";
			this->Text = L"Mamiferos";
